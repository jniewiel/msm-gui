Rails.application.routes.draw do
  ...
  get("/delete_movie/:an_id", { :controller => "directors", :action => "destroy" })
  get("/modify_director/:the_id", { :controller => "directors", :action => "update" })
  ...
  get("/modify_actor/:the_id", { :controller => "actors", :action => "update" })
end
